...
// import { ArrowLeft, CheckCircle, Phone, Video, MessageCircle, Calendar, Clock, Languages, Award, MapPin } from "lucide-react";
...
//             <p className="text-xs md:text-base text-black/60">{lawyer.reviews} reviews</p>
//           </div>
//           <div className="bg-white rounded-2xl px-2 md:px-8 py-4 md:py-6 shadow-sm text-center">
//             <p className="text-base md:text-3xl font-normal text-black">{lawyer.experience}yr</p>
...
//             <MapPin className="w-4 h-4 md:w-6 md:h-6 text-[#554116]/40" />
